...
public class HatCandy extends Item
{
	...
	public HatCandy(PLordPlayScreen screen, float x, float y)
	{
		...
		setRegion(screen.getAtlas().findRegion("HatCandy"), 0, 0, 35, 35);
