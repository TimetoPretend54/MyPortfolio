...
from saveImageBaxter import saveBaxterImage

def recognizeImage(img1, matchCount): 	# If passing needed arguments to function
#def recognizeImage():
	...
	#imgs = ['Assets/beginclose1.png', 'Assets/brewingclose2.png', 'Assets/doneclose2.png', 'Assets/fillingclose1.png', 'Assets/preheatclose1.png', 'Assets/poweroffclose2.png', 'Assets/readyclose2.png', 'Assets/waterclose1.png', 'Assets/welcomeclose2.png']
	imgs = img1;
	...
	for i in imgs:
		...
		#sift = cv2.SIFT() #Not for version 3.3
		sift = cv2.xfeatures2d.SIFT_create() #for version 3.3
