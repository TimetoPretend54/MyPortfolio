...
def saveBaxterImage():
	...
	for i in range (0, 2):
		...
		#cropped = image[70:170, 440:540] 	# 1st parameter is start Y and end Y coordinates for crop
											# 2nd parameter is start X and end X coordinates for crop
		#cv2.imwrite('BaxterCamPicture/imageCapture.png', cropped)
